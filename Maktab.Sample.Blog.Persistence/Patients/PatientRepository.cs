...
{
    public class PatientRepository : GenericRepository<Patient, BlogDbContext>, IPatientRepository
    {
        public PatientRepository(BlogDbContext dbContext, ILogger<PatientRepository> logger) : base(dbContext, logger)
        {
        }
